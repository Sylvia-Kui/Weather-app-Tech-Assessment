...
- Create a .env file or insert your API key directly in the script:
...
📬 Contact
For questions or collaboration, reach out to Sylvia Karanja via GitHub.📄 LicenseThis project is for educational and assessment purposes only.
---
